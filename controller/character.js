...
const equipItem = async (characterId, itemId) => {
    ...
    const equippedItemIndex = character.inventory.findIndex(item => item.id === itemId)
    const replacedItemIndex = character.gear.findIndex(item => item.type === equippedItem.type) 
